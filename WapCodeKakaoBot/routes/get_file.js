...
router.get('/:user_key/:title', function (req, res, next) {
    ...
    var sc = '<link rel="stylesheet" href="/stylesheets/highjs/darcula.css">\n' +
        '<script src="/javascripts/highjs/highlight.js"></script>\n' +
    ...
    var st = sc+'<pre><code class="c">' + buffer + '</code></pre>';
    console.log(st);
    res.send(st);
});
